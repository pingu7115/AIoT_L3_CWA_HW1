...
def get_rain_advisory(max_rain):
    """計算目前降雨警報等級 (Morandi 色系)"""
    if max_rain >= 500:
        return "🚨 超大豪雨警戒", "#cc7a7a", "24 小時累積雨量達 500 毫米以上，請特別嚴防淹水與土石流！"
    elif max_rain >= 350:
        return "🚨 大豪雨警戒", "#c88b76", "24 小時累積雨量達 350 毫米以上，山區及低窪地區請高度戒備。"
    elif max_rain >= 200:
        return "⚠️ 豪雨特報等級", "#d4a373", "局部地區有豪雨發生，請注意雷擊、強陣風及落石坍方。"
    elif max_rain >= 80:
        return "🌧️ 大雨特報等級", "#9bb5c4", "局部地區有大雨發生機率，外出請攜帶雨具並注意行車安全。"
    elif max_rain > 10:
        return "🌦️ 局部零星降雨", "#88a28d", "局部山區或沿海有短暫陣雨，多數平地地區天氣大致穩定。"
    else:
        return "🌤️ 全台大致晴朗/少雨", "#88a28d", "今日全台各地水氣偏少，僅少數零星微量降雨或無顯著雨勢。"
